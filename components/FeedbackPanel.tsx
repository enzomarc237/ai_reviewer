      ...
      <div className="bg-slate-900 p-4 rounded-lg flex-grow overflow-auto">
        ...
        {!isLoading && !error && feedback && (
          <div 
            ...
            // Using prose classes for basic markdown styling. Tailwind typography plugin would enhance this.
            // For now, whitespace-pre-wrap is key for Gemini's text formatting.
          >
            {feedback}
          </div>
        )}
